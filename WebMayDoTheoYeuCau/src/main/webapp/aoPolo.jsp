...
<head>
    ...
    <title>Áo Polo - THREEN TAILORED</title>
    ...
    <section class="container my-4">
        ...
        <div class="vest-title">
            <div class="vest-header">
                <h2>Áo Polo May Đo Cho Quý Ông</h2>
            </div>
            <!-- Sắp Xếp và Lọc -->
        ...
        <p class="vest-description">
            Biểu tượng của quý ông hiện đại, áo polo, còn được biết đến với tên gọi áo golf
            hoặc áo tennis, là sự kết hợp hoàn hảo giữa áo sơ mi cổ điển và áo thun.
            Là tâm điểm của tủ đồ mùa hè, áo polo vừa thoải mái cho các hoạt động thường ngày
            vừa đủ lịch sự cho những dịp công sở. Áo polo đặt may theo yêu cầu có thể được tùy
            chỉnh với kiểu tay ngắn hoặc tay dài. Chúng được làm từ chất liệu vải pique mềm mại
            và thoáng khí, mang lại sự thoải mái tối ưu.
            Khám phá bộ sưu tập áo polo dành cho nam giới của chúng tôi và cá nhân hóa theo phong
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4 position-relative">
                <a href="detail.jsp" class="full-link">
                    <div id="polo-1" class="single-product">
                        <div class="part-1">
                            <ul>
                        ...
                        <div class="part-2">
                            ...
                            <h3 class="product-title">Áo Polo Xám Chất Liệu Cotton Piquet</h3>
            ...
            <div class="col-md-6 col-lg-4 position-relative ">
                <a href="detail.jsp" class="full-link">
                    <div id="polo-2" class="single-product">
                        <div class="part-1">
                        ...
                        <div class="part-2">
                            <div class="product-season">Bốn Mùa</div>
                            <h3 class="product-title">Áo Polo Trắng Chất Liệu Cotton Jersey</h3>
                            <div class="product-maker">đức nghĩa</div>
                            <h4 class="product-price">1,300,000 VND</h4>
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-lg-4 position-relative">
                <a href="detail.jsp" class="full-link">
                    <div id="polo-3" class="single-product">
                        <div class="part-1">
                            <ul>
                                <li><a href="#"><i class="fas fa-shopping-cart"></i></a></li>
                                <li><a href="#"><i class="fas fa-heart"></i></a></li>
                        ...
                        <div class="part-2">
                            ...
                            <h3 class="product-title">Áo Polo Chất Liệu Jersey Trắng</h3>
                            <div class="product-maker">đức nghĩa</div>
                            <h4 class="product-old-price">1,500,000 VND</h4>
                            <h4 class="product-price">1,300,000 VND</h4>
                        </div>
            ...
            <div class="col-md-6 col-lg-4 position-relative">
                <a href="detail.jsp" class="full-link">
                    <div id="polo-4" class="single-product">
                        <div class="part-1">
                        ...
                        <div class="part-2">
                            <div class="product-season">Bốn Mùa</div>
                            <h3 class="product-title">Áo Polo Cotton Jersey Trắng</h3>
            ...
            <div class="col-md-6 col-lg-4 position-relative">
                <a href="detail.jsp" class="full-link">
                    <div id="polo-5" class="single-product">
                        <div class="part-1">
                            <ul>
                                <li><a href="#"><i class="fas fa-shopping-cart"></i></a></li>
                                <li><a href="#"><i class="fas fa-heart"></i></a></li>
                        ...
                        <div class="part-2">
                            <div class="product-season">Bốn Mùa</div>
                            <h3 class="product-title">Áo Polo Cotton Piquet Trắng</h3>
                            <div class="product-maker">trọng nhân</div>
                            <h4 class="product-old-price">1,500,000 VND</h4>
                            <h4 class="product-price">1,300,000 VND</h4>
                        </div>
            ...
            <div class="col-md-6 col-lg-4 position-relative">
                <a href="detail.jsp" class="full-link">
                    <div id="polo-6" class="single-product">
                        <div class="part-1">
                            <span class="discount">Giảm 15%</span>
                            <ul>
                                <li><a href="#"><i class="fas fa-shopping-cart"></i></a></li>
                        ...
                        <div class="part-2">
                            <div class="product-season">Bốn Mùa</div>
                            <h3 class="product-title">Áo Polo Màu Xanh</h3>
                            <div class="product-maker">trọng nhân</div>
                            <h4 class="product-price">1,300,000 VND</h4>
                        </div>
                    </div>
