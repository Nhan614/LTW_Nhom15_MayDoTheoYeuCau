...
<body>
    ...
    <div class="contact-menu">
        ...
        <div class="contact-item-ak">
            <a href="contactUs.html"><i class="fa-solid fa-envelope"></i></a> Email
        </div>
        <div class="contact-item-ak">
        ...
        <footer class="footer text-center py-4">
            <div class="footer-container">
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        <li><a href="cauhoitg.html">Câu hỏi thường gặp</a></li>
                        <li><a href="baodampl.html">Bảo đảm pháp lý</a></li>
                        <li><a href="trahang.html">Chính sách trả hàng</a></li>
                        <li><a href="vanchuyen.html">Thông tin vận chuyển</a></li>
                    </ul>
                </div>
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        ...
                        <li><a href="hoptac.html">Hợp tác với chúng tôi</a></li>
                        <li><a href="company.html">Dữ liệu công ty</a></li>
            ...
            <div class="container">
                ...
                <ul class="list-inline">
                    <li class="list-inline-item"><a href="baomat.html">Chính sách bảo mật</a></li>
                    <li class="list-inline-item"><a href="dieukhoan.html">Điều khoản và điều kiện</a></li>
                    <li class="list-inline-item"><a href="contactUs.html">Liên hệ với chúng tôi</a></li>
                </ul>
            </div>
        </footer>
    </div>
