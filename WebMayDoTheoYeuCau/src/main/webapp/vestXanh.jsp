...
<body>
    ...
    <section class="container my-4 section-products">
        <div class="row">
            <c:forEach var="vestXanh" items="${products}">
                <c:if test="${vestXanh.categoryID == 3}">
                    <div class="col-md-6 col-lg-4 position-relative">
                        <a href="detail.jsp?id=${vestXanh.id}" class="full-link">
                            <div class="single-product">
                                <div class="part-1">
                                    <img src="${vestXanh.image}" alt="${vestXanh.productName}">
                                    <ul>
                                ...
                                <div class="part-2">
                                    <h3 class="product-title">${vestXanh.productName}</h3>
                                    <p class="product-season">${vestXanh.season}</p>
                                    <div class="product-maker">${vestXanh.maker}</div>
                                    <h4 class="product-price">${vestXanh.price} VND</h4>
                                </div>
                            </div>
                        </a>
                    </div>
