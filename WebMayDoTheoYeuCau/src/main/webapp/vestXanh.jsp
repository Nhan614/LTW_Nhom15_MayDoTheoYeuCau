        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4 position-relative">
                <a href="detail.jsp" class="full-link">
                    <div id="vestXanh-1" class="single-product">
                        <div class="part-1">
                            <ul>
                        ...
                        <div class="part-2">
                            ...
                            <h3 class="product-title">Bộ Vest Icon Midnight Xanh</h3>
            ...
            <div class="col-md-6 col-lg-4 position-relative">
                <a href="detail.jsp" class="full-link">
                    <div id="vestXanh-2" class="single-product">
                        <div class="part-1">
                        ...
                        <div class="part-2">
                            <div class="product-season">Bốn Mùa</div>
                            <h3 class="product-title">>Bộ Vest Icon Bird's Eye Xanh</h3>
                            <div class="product-maker">đức nghĩa</div>
                            <h4 class="product-price">1,300,000 VND</h4>
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-lg-4 position-relative">
                <a href="detail.jsp" class="full-link">
                    <div id="vestXanh-3" class="single-product">
                        <div class="part-1">
                            <ul>
                                <li><a href="#"><i class="fas fa-shopping-cart"></i></a></li>
                                <li><a href="#"><i class="fas fa-heart"></i></a></li>
            ...
            <div class="col-md-6 col-lg-4 position-relative">
                <a href="detail.jsp" class="full-link">
                    <div id="vestXanh-4" class="single-product">
                        <div class="part-1">
            ...
            <div class="col-md-6 col-lg-4 position-relative">
                <a href="detail.jsp" class="full-link">
                    <div id="vestXanh-5" class="single-product">
                        <div class="part-1">
                            <ul>
                                <li><a href="#"><i class="fas fa-shopping-cart"></i></a></li>
                                <li><a href="#"><i class="fas fa-heart"></i></a></li>
                        ...
                        <div class="part-2">
                            <div class="product-season">Bốn Mùa</div>
                            <h3 class="product-title">Bộ Vest Sọc Dành Cho Lễ Hội </h3>
                            <div class="product-maker">trọng nhân</div>
                            <h4 class="product-old-price">1,500,000 VND</h4>
                            <h4 class="product-price">1,300,000 VND</h4>
                        </div>
            ...
            <div class="col-md-6 col-lg-4 position-relative">
                <a href="detail.jsp" class="full-link">
                    <div id="vestXanh-6" class="single-product">
                        <div class="part-1">
                            <span class="discount">Giảm 15%</span>
                            <ul>
                                <li><a href="#"><i class="fas fa-shopping-cart"></i></a></li>
                        ...
                        <div class="part-2">
                            <div class="product-season">Bốn Mùa</div>
                            <h3 class="product-title">Bộ Vest Prince of Wales Xanh</h3>
                            <div class="product-maker">trọng nhân</div>
                            <h4 class="product-price">1,300,000 VND</h4>
                        </div>
                    </div>
            ...
            <div class="col-md-6 col-lg-4 position-relative">
                <a href="detail.jsp" class="full-link">
                    <div id="vestXanh-7" class="single-product">
                        <div class="part-1">
                            <ul>
                                <li><a href="#"><i class="fas fa-shopping-cart"></i></a></li>
                                <li><a href="#"><i class="fas fa-heart"></i></a></li>
                        ...
                        <div class="part-2">
                            ...
                            <h3 class="product-title">Bộ Vest Flannel Chải Màu Xanh Đậm</h3>
            ...
            <div class="col-md-6 col-lg-4 position-relative">
                <a href="detail.jsp" class="full-link">
                    <div id="vestXanh-8" class="single-product">
                        <div class="part-1">
                            <span class="new">Mới</span>
                            <ul>
                                <li><a href="#"><i class="fas fa-shopping-cart"></i></a></li>
                        ...
                        <div class="part-2">
                            ...
                            <h3 class="product-title">Bộ Vest Optm Xanh</h3>
                            <div class="product-maker">nhân nghĩa</div>
                            <h4 class="product-price">1,300,000 VND</h4>
                        </div>
                    </div>
